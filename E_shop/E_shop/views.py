...
def PRODUCT(request):
    ...
    filter_price = Filter_Price.objects.filter()
    ...
    NEW_PROIDDUCTID = request.GET.get('NEW_PRODUCT')
...
def Contact_Page(request):
    if request.method == 'POST':
        ...
        try:
            send_mail(subject, message, email_from, ['g60509456@gmail.com'])
            contact.save()
